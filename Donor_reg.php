...
(NAME, FATHER_NAME, GENDER, DOB, BLOOD, BODY_WEIGHT, EMAIL,password, ADDRESS, AREA, CITY, CONTACT_1, NEW_DONOR, LAST_D_DATE, DONOR_PIC,COUNTRY)
 VALUES
 ('{$_POST["NAME"]}', '{$_POST["FATHER_NAME"]}', '{$_POST["GENDER"]}', '{$_POST["DOB"]}', '{$_POST["BLOOD"]}', '{$_POST["BODY_WEIGHT"]}', '{$_POST["EMAIL"]}','{$_POST["password"]}', '{$_POST["ADDRESS"]}', '{$_POST["AREA"]}', '$cityname',  '{$_POST["CONTACT_1"]}',  '{$_POST["NEW_DONOR"]}','{$_POST["LAST_D_DATE"]}', '{$img}','{$country}');";
						if($con->query($sql))
							{
								echo '
                ...
                <div class="panel panel-primary" style="background-color: #59b300;">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
							...
							<input type="text" placeholder="Father Name" id="FN" name="FATHER_NAME" required class="form-control input-sm">
						</div>
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" required name="password" id="password" class="form-control" placeholder="Password">
                          </div>
						  ...
						  <div class="form-group">
						   ...
						   <div class="form-group">
                                ...
                                <input type="number"  size="11" required name="CONTACT_1" id="CONTACT_1" class="form-control" placeholder="Contact">
                          </div>
						...
						<div class="form-group">
						  ...
						  <div class="form-group">
							<button class="btn btn-primary" type="submit" name="submit" id="BTN" >Registar Now</button>
						  </div>
						 </form>
                    </div>
                </div>
...
<div class="col-sm-6"> <br><h3 style="position: fixed; color:black;text-align: center;"> JOIN AS A BLOOD DONOR<br> <br><img src="images/sh.jpg" width=700px,height=400px;"> </div>
        </div></h3>
