...
<ul class="nav nav-stacked">
	...
	<li><a href="admin_need_blood.php"><i class="fa fa-bed fa-lg"></i> Blood  	Receiver</a></li>
	<li><a href="admin_manage_camps.php"><i class="fa fa-picture-o fa-lg"></i> Manage Cmaps</a></li>
	<li><a href="admin_manage_b_bank.php"><i class="fas fa-hand-holding-heart"></i> Manage Blood Bank</a></li>
	<hr>
